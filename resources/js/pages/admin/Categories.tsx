...
export default function Categories() {
    ...
    useEffect(() => {
        if (token) { fetchCategories(); fetchDepartments(); }
    }, [token]);
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Dialog rendered at top level, not nested inside the header row */}
                                ...
                                <TableRow key={cat.id}>
                                    ...
                                    <TableCell>
                                        <Badge
                                            ...
                                            className={cat.status === "Active" ? "bg-green-100 text-green-800 hover:bg-green-200 border-green-200" : "bg-slate-100 text-slate-800 hover:bg-slate-200 border-slate-200"}
                                        >
                                            {cat.status}
                                        </Badge>
                                    </TableCell>
