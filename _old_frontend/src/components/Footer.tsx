    ...
    <footer className="bg-brand-charcoal text-primary-foreground">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
              ...
              <p className="text-primary-foreground/70 mb-6 leading-relaxed">
                Bringing the authentic taste of Africa to your doorstep. Quality products, traditional flavors.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <a href="mailto:hello@sarafinafoods.com" className="text-primary-foreground/70 hover:text-secondary transition-colors">
                    hello@sarafinafoods.com
                  </a>
                </li>
              </ul>
            </div>
      ...
      <div className="border-t border-primary-foreground/10 py-6">
        <div className="container flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-primary-foreground/60">
          <p>© 2026 Sarafina Foods. All rights reserved.</p>
